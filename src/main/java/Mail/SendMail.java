...
public class SendMail {
	public static void sendfile(int count_totalTCs, int count_passedTCs, int count_failedTCs, int count_skippedTCs) throws Exception {
		String messageBody = getTestCasesCountInFormat(count_totalTCs, count_passedTCs, count_failedTCs,count_skippedTCs);
                
		
		String fileTestReport = System.getProperty("user.dir") + "\\ExtentReports\\ExtentReport.html";
	                
        EmailAttachments.sendEmailWithAttachments(EmailConfig.SERVER, EmailConfig.PORT, EmailConfig.FROM, EmailConfig.PASSWORD, EmailConfig.TO, EmailConfig.SUBJECT,messageBody, fileTestReport);
